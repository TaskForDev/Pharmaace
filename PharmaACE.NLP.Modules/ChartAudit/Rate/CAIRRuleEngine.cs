...
{
    class CAIRRuleEngine : CARuleEngine
    {
        public CAIRRuleEngine(RecognizedEntity measureRE)
        {
        ...
        protected override void SetNamedEntityDimensions()
        {
            ...
            NamedEntityDimensions = new List<NED> {
                    new Tumor { Components = new List<NED> { tg, tl, ts, tts } },
                    new Time()
                };
        }
